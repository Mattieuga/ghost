...
describe("file classification", () => {
  it.each([
    ...
    ["book.MOBI", "ebook", "viewer-owned", false],
    ["book.azw3", "ebook", "viewer-owned", false],
    ["book.fb2", "ebook", "viewer-owned", false],
    ["comic.cbz", "comic", "viewer-owned", false],
    ["comic.CBR", "comic", "viewer-owned", false],
